...
export class MultipleComponent implements OnInit{
  ...
  btn_CreateChart(): void {
    ...
    // 此頁面跳轉
    this.router.navigate(['/CompanyNum_Chart']);
    // 跳出新分頁
